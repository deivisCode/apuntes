...
#notacion[
    ...
    $KK$. Ademais, a operación do grupo soe ser $+$ e a primeira do campo $+$
    ...
    V, k in KK$ escríbese simplemente como $k v$. Finalmente, referímonos a
    $((V,+),(KK,+,dot),circle.stroked.tiny)$ simplemente como o espazo lineal
    $(V,KK,+)$, un _$KK$-espazo lineal_ ou un _espazo lineal sobre $KK$_. No
    límite de abusar da notación, referirémonos ao espazo lineal só polo nome
    do grupo, $V$, ou ás veces dito nome e o campo como subíndice $V_KK$.
]
...
#notacion[
    ...
    calquera nivel e situación. Eu, pra evitar confusións, vou seguir *sempre*
    unha notación concreta:
